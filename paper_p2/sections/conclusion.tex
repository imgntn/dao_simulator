...
\begin{enumerate}
    \item \textbf{Treasury resilience}: How treasury buffers and buyback caps impact volatility and long-run sustainability under shocks.

    \item \textbf{Inter-DAO cooperation}: Under what conditions cross-DAO resource-sharing and joint-venture proposals improve welfare versus increase conflict.

    \item \textbf{Design principles}: What simulation-conditional guidance emerges from these economic and coordination dynamics.
\end{enumerate}
