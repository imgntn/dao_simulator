...
\begin{description}
    \item[RQ4:] How do treasury buffers and buyback caps impact treasury volatility and long-run sustainability under shocks?
    \item[RQ5:] Under what conditions do cross-DAO resource-sharing or joint-venture proposals improve welfare versus increase conflict?
\end{description}

\noindent A companion paper addresses participation dynamics (RQ1), governance capture (RQ2), and proposal pipeline design (RQ3).
