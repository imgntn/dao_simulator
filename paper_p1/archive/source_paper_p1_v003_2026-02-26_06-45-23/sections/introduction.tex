...
\begin{description}
    \item[RQ1:] How do participation incentives and delegation policies affect turnout, quorum reach, and decision quality?
    \item[RQ2:] Do voting power mitigations (caps, quadratic thresholds, velocity penalties) reduce governance capture without harming throughput?
    \item[RQ3:] How does a temp-check $\rightarrow$ on-chain proposal pipeline change pass rates, time-to-decision, and abandonment?
\end{description}

\noindent A companion paper addresses treasury resilience (RQ4) and inter-DAO cooperation (RQ5).
