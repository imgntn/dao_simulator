...
Across 21402 simulation runs and 10 experiment sets, we target the following empirical questions:

\begin{enumerate}
    \item \textbf{Participation dynamics}: How participation incentives and delegation policies affect turnout, quorum reach, and decision quality.

    \item \textbf{Governance capture}: Whether voting power mitigations (caps, quadratic thresholds, velocity penalties) reduce capture without harming throughput.

    \item \textbf{Proposal pipeline}: How temp-check $\rightarrow$ on-chain pipelines change pass rates, time-to-decision, and abandonment.

    \item \textbf{Design principles}: What simulation-conditional guidance emerges from these core governance mechanics.
\end{enumerate}
...
% Current version reflects 10 experiment sets with 21402 total runs.
% Last updated: 2026-01-29T23:44:08.278Z
