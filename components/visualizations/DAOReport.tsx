    ...
    <div className="w-full p-6 bg-gray-800 rounded-lg shadow-lg">
      ...
      <div className="h-[300px] flex items-center justify-center border-2 border-dashed border-gray-700 rounded-lg">
        <div className="text-center px-4">
          ...
          <p className="text-gray-500 text-xs mt-1">Run a simulation to generate a report</p>
        </div>
      </div>
    </div>
  );
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <span className="text-sm text-gray-400">
          {stats?.totalSteps} steps completed
        </span>
      </div>
      ...
      {stats && (
        ...
        >
          ...
          <StatCard
            ...
            subValue={`${stats.priceChange >= 0 ? 'Up' : 'Down'} ${Math.abs(stats.priceChange).toFixed(2)}%`}
          ...
          <StatCard
            ...
            subValue={`Range: $${stats.minTreasury.toFixed(0)} - $${stats.maxTreasury.toFixed(0)}`}
            color="purple"
          ...
          <StatCard
            ...
            subValue={`of ${proposals.length} total`}
            color="pink"
      ...
      {simulationData.length > 0 && (
        <div className="w-full">
          <h3 className="text-lg font-semibold mb-2 text-white">Treasury Over Time</h3>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold text-white flex items-center gap-2">
              ...
              Market Shocks ({sortedShocks.length})
            </h3>
            {sortedShocks.length > 5 && (
              ...
              >
                {showAllShocks ? 'Show less' : `Show all ${sortedShocks.length}`}
              </button>
            )}
          </div>
