...
export function PageShell({ children, variant = 'home', locale }: PageShellProps) {
  ...
  // Print support: open all <details> before printing, restore after
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <SiteHeader />
      <div className="mx-auto w-full max-w-7xl px-4 pb-24 pt-8 sm:px-6 lg:px-8 lg:pt-12">
        {children}
