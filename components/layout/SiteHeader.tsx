      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center rounded-lg border border-[var(--border-default)] bg-[var(--surface-warm)] p-1.5 text-[var(--text-body)] transition hover:border-[var(--accent-teal)] hover:text-[var(--accent-teal)]"
          >
            {theme === 'dark' ? (
          ...
          {open && (
            <ul
              ...
              className="absolute right-0 mt-1 w-40 overflow-hidden rounded-lg border border-[var(--border-default)] bg-[var(--surface-warm)] shadow-lg"
            >
              {locales.map((loc) => (
