...
| `npm run test` | Vitest unit suite with coverage (1006 tests) |
...
- **Unit tests**: `npm run test` — 1006 Vitest tests covering simulation engine, data collector, agents, learning, calibration, voting mechanisms, LLM integration, auth, validation, analytics, event utilities, proxy security, readiness checks, environment validation, path safety, API hardening, and browser-facing simulation state. V8 coverage enabled.
