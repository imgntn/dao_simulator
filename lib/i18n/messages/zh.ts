...
export const messages: Messages = {
  ...
  home: {
    ...
    heroDescription: '\u6765\u81ea 17 \u79cd\u5b9e\u9a8c\u914d\u7f6e\u7684 21,869 \u6b21\u4eff\u771f\u8fd0\u884c\u7684\u53ef\u64cd\u4f5c\u6cbb\u7406\u53d1\u73b0\u3002\u4ece\u4e0b\u65b9\u4efb\u610f\u7814\u7a76\u95ee\u9898\u5f00\u59cb\u3002',
    heroCta: '\u63a2\u7d22\u7814\u7a76',
    nav: '\u4e3b\u5bfc\u822a',
    consoleLink: '\u63a7\u5236\u53f0',
    researchHeading: '\u7814\u7a76',
    ...
    whyItMatters: '\u4e3a\u4ec0\u4e48\u91cd\u8981\uff1a',
    evidenceLabel: '\u8bc1\u636e\u57fa\u7840',
    evidenceDesc: '\u786e\u8bc1\u5b9e\u9a8c\u6b63\u5728\u6839\u636e\u51bb\u7ed3\u8bbe\u8ba1\u548c\u5df2\u9a8c\u8bc1\u7684\u539f\u59cb\u8fd0\u884c\u91cd\u65b0\u751f\u6210\u3002',
    briefsLabel: '\u51b3\u7b56\u7b80\u62a5',
    ...
    digitalTwinsHow: '\u5386\u53f2\u914d\u7f6e\u9a71\u52a8\u4ee3\u7406\u884c\u4e3a\u548c\u6cbb\u7406\u8282\u594f\u30022025\u5e74\u65f6\u5e8f\u7559\u51fa\u8bc4\u4f30\u7684\u5e73\u5747\u590d\u5408\u76f8\u4f3c\u5ea6\u4e3a0.473\uff1b\u6821\u51c6\u8fd0\u884c\u572814\u4e2aDAO\u4e2d\u67095\u4e2a\u4f18\u4e8e\u6301\u7eed\u6027\u57fa\u7ebf\uff0c8\u4e2a\u4f18\u4e8e\u672a\u6821\u51c6\u6a21\u62df\u5668\u3002',
  ...
  simulation: {
    ...
    tabResearch: '\u7814\u7a76',
    scenarioStep: '\u6b65\u9aa4',
    scenarioSeverity: '\u4e25\u91cd\u7a0b\u5ea6',
    scenarioAdd: '\u6dfb\u52a0',
    multiRunStats: '\u591a\u6b21\u8fd0\u884c\u7edf\u8ba1',
    multiRunClear: '\u6e05\u9664',
    multiRunRuns: '\u8fd0\u884c\u6b21\u6570\uff1a',
    govDefault: '\u9ed8\u8ba4\uff08\u6765\u81ea\u6821\u51c6\uff09',
    govMajority: '\u7b80\u5355\u591a\u6570',
    govSupermajority: '\u7edd\u5bf9\u591a\u6570 (67%)',
    govQuadratic: '\u4e8c\u6b21\u65b9\u6295\u7968',
    govConviction: '\u4fe1\u5ff5\u6295\u7968',
    govOptimistic: '\u4e50\u89c2\u6279\u51c6',
    govIRV: '\u5373\u65f6\u51b3\u9009\u6295\u7968 (IRV)',
    govFutarchy: '\u672a\u6765\u5236',
    eventExploit: '\u667a\u80fd\u5408\u7ea6\u6f0f\u6d1e',
    eventRegulatory: '\u76d1\u7ba1\u884c\u52a8',
    eventMarketCrash: '\u5e02\u573a\u5d29\u76d8',
    eventWhaleExit: '\u5de8\u9cb8\u9000\u51fa',
    eventContagion: 'DeFi\u4f20\u67d3',
    eventOracle: '\u9884\u8a00\u673a\u6545\u969c',
    skipTutorial: '\u8df3\u8fc7\u6559\u7a0b',
  },
};
