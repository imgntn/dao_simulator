...
export const messages: Messages = {
  ...
  home: {
    ...
    evidenceDesc: 'La campa\u00f1a confirmatoria se est\u00e1 regenerando a partir de dise\u00f1os congelados y ejecuciones verificadas.',
    ...
    digitalTwinsHow: 'Los perfiles hist\u00f3ricos impulsan el comportamiento y la cadencia de gobernanza. Una reserva temporal de 2025 produjo una similitud compuesta media de 0,473; las ejecuciones calibradas superaron la persistencia en 5/14 DAO y un simulador no calibrado en 8/14.',
    ...
    noOutcomePoints: 'No se encontraron puntos de resultado para este informe.',
    seeAlso: 'Ver tambi\u00e9n:',
    consultingHeading: 'Trabaja Conmigo',
    consultingDesc: '\u00bfBuscas orientaci\u00f3n experta en dise\u00f1o de gobernanza DAO, simulaci\u00f3n basada en agentes o toma de decisiones descentralizada? Ofrezco consultor\u00eda en dise\u00f1o de mecanismos de gobernanza, estrategias de calibraci\u00f3n y an\u00e1lisis de pol\u00edticas basado en simulaci\u00f3n para DAOs y equipos de protocolos.',
    consultingCta: 'Cont\u00e1ctame',
  },
  ...
  simulation: {
    controlPanel: 'Control de Simulaci\u00f3n',
    configChanged: 'Configuraci\u00f3n cambiada',
    applyLive: 'Aplicar en vivo',
    daoPreset: 'Preset de DAO',
    governanceRule: 'Regla de Gobernanza',
    forum: 'Foro',
    blackSwans: 'Cisnes Negros',
    randomSeed: 'Semilla Aleatoria',
    agentCounts: 'Cantidad de Agentes',
    speed: 'Velocidad',
    stepsPerSec: 'pasos/seg',
    fork: 'Bifurcar',
    tabInteractive: 'Interactivo',
    tabCompare: 'Comparar',
    tabBranch: 'Rama',
    tabMultiRun: 'Multi-Ejecuci\u00f3n',
    tabResearch: 'Investigaci\u00f3n',
    scenarioStep: 'Paso',
    scenarioSeverity: 'Severidad',
    scenarioAdd: 'Agregar',
    multiRunStats: 'Estad\u00edsticas Multi-Ejecuci\u00f3n',
    multiRunClear: 'Limpiar',
    multiRunRuns: 'Ejecuciones:',
    govDefault: 'Predeterminado (de calibraci\u00f3n)',
    govMajority: 'Mayor\u00eda Simple',
    govSupermajority: 'Supermayo\u00eda (67%)',
    govQuadratic: 'Votaci\u00f3n Cuadr\u00e1tica',
    govConviction: 'Votaci\u00f3n por Convicci\u00f3n',
    govOptimistic: 'Aprobaci\u00f3n Optimista',
    govIRV: 'Segunda Vuelta Instant\u00e1nea (IRV)',
    govFutarchy: 'Futarqu\u00eda',
    eventExploit: 'Exploit de Contrato Inteligente',
    eventRegulatory: 'Acci\u00f3n Regulatoria',
    eventMarketCrash: 'Ca\u00edda del Mercado',
    eventWhaleExit: 'Salida de Ballena',
    eventContagion: 'Contagio DeFi',
    eventOracle: 'Fallo de Or\u00e1culo',
