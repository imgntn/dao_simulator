...
export const messages: Messages = {
  ...
  metadata: {
    ...
    description:
      'Explore DAO governance hypotheses from 21,869 legacy agent-based simulation runs across 14 calibrated digital twins. Numerical findings are exploratory while the frozen confirmatory campaign is completed. By James B. Pollack.',
    keywords: [
      'DAO',
      'governance',
      'simulation',
  ...
  home: {
    ...
    heroDescription: 'Explore governance hypotheses from 21,869 legacy simulation runs across 17 experiment configurations. Confirmatory validation is pending.',
    ...
    evidenceDesc: 'The confirmatory campaign is being regenerated from frozen designs and verified raw runs.',
    ...
    digitalTwinsHow: 'Historical profiles drive agent behavior and governance cadence. A 2025 temporal holdout produced 0.473 mean composite similarity; calibrated runs beat persistence for 5/14 DAOs and an uncalibrated simulator for 8/14.',
    ...
    noOutcomePoints: 'No extracted outcome points found for this brief.',
    seeAlso: 'See also:',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SIMULATION - Simulation UI strings
  // ═══════════════════════════════════════════════════════════════════════════
  simulation: {
    controlPanel: 'Simulation Control',
    configChanged: 'Config changed',
    applyLive: 'Apply Live',
    daoPreset: 'DAO Preset',
    governanceRule: 'Governance Rule',
    forum: 'Forum',
    blackSwans: 'Black Swans',
    randomSeed: 'Random Seed',
    agentCounts: 'Agent Counts',
    speed: 'Speed',
    stepsPerSec: 'steps/sec',
    fork: 'Fork',
    tabInteractive: 'Interactive',
    tabCompare: 'Compare',
    tabBranch: 'Branch',
    tabMultiRun: 'Multi-Run',
    tabResearch: 'Research',
    scenarioStep: 'Step',
    scenarioSeverity: 'Severity',
    scenarioAdd: 'Add',
    multiRunStats: 'Multi-Run Statistics',
    multiRunClear: 'Clear',
    multiRunRuns: 'Runs:',
    govDefault: 'Default (from calibration)',
    govMajority: 'Simple Majority',
    govSupermajority: 'Supermajority (67%)',
    govQuadratic: 'Quadratic Voting',
    govConviction: 'Conviction Voting',
    govOptimistic: 'Optimistic Approval',
    govIRV: 'Instant Runoff (IRV)',
    govFutarchy: 'Futarchy',
    eventExploit: 'Smart Contract Exploit',
    eventRegulatory: 'Regulatory Action',
    eventMarketCrash: 'Market Crash',
    eventWhaleExit: 'Whale Exit',
    eventContagion: 'DeFi Contagion',
    eventOracle: 'Oracle Failure',
