...
\begin{lstlisting}[caption=Agent behavior model (pseudocode)]
class Agent:
...
\midrule
Investor & 0.8 & 20-30\% & Self & Large holders, high engagement \\
...
Total implementation: approximately 44,000 lines of TypeScript across simulation engine, agent models, governance mechanisms, research CLI, and visualization components.
