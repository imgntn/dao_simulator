...
Additionally, we validate the simulator through a historical data calibration pipeline (Experiment~10) that compares outputs against 14 real-world DAOs, achieving an average accuracy score of 0.856 across governance, participation, and treasury metrics (Section~\ref{sec:results}).
