...
\begin{enumerate}
    ...
    \item \textbf{Empirical Analyses}: A reproducible experiment suite and analysis pipeline; results are reported as runs complete ({{TOTAL_RUNS}} total runs across {{EXPERIMENT_COUNT}} experiment sets in this version).
