...
\begin{enumerate}
    ...
    \item \textbf{Historical Data Calibration}: A chronological train/holdout pipeline for 14 DAO twins, including source-hashed profiles, historical and uncalibrated null comparisons, per-DAO uncertainty, and counterfactual governance analysis. The held-out mean composite similarity is 0.473, with heterogeneous rather than universal predictive skill.
