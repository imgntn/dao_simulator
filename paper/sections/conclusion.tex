...
\begin{enumerate}
    ...
    \item A historical-data pipeline evaluating 14 DAO twins on a temporal holdout, with mean composite similarity 0.473 and explicitly heterogeneous skill versus persistence and an uncalibrated simulator
