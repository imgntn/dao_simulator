...
\begin{enumerate}
    ...
    \item A historical data calibration pipeline validating simulator outputs against 14 real-world DAOs with an average accuracy score of 0.770
...
\begin{itemize}
    \item \texttt{lib/}: Core simulation engine (TypeScript, 44{,}000+ lines)
...
\begin{itemize}
    \item Runtime: Approximately 2.5 hours for full experiment suite (4 parallel workers)
    \item Memory: 8GB RAM minimum, 16GB recommended
    \item Storage: 500MB for full results
\end{itemize}
