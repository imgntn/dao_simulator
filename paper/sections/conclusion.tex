...
Through 6 simulation runs across 1 experimental configurations, we have established several key findings:
...
\begin{enumerate}
    ...
    \item \textbf{Scale effects}: Participation decays as a power law with DAO size ($\beta \approx 0.35$), suggesting fundamental coordination costs.
...
% Current version reflects 1 experiments with 6 total runs.
% Last updated: 2026-01-15T07:27:20.548Z
