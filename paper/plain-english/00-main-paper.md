...
| [RQ6](./rq6-llm-agent-reasoning.md) | LLM Governance | 300 | LLM agents DECREASE pass rates; all-LLM is worst; 3 small models tested |
...
- **21,869 simulation runs** across 13 research areas
- **17 experiments** covering quorum design, capture mitigation, pipeline effects, treasury policy, inter-DAO cooperation, AI governance, counterfactual rule comparison, scale effects, voting mechanisms, shock resilience, reinforcement learning, calibration validation, and advanced mechanisms
