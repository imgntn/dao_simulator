...
| [RQ7](./rq7-counterfactual-governance.md) | Counterfactual Governance Rules | 125 | Conviction voting universally collapses; most other rules are interchangeable |

## Total Experiment Scale

- **7,777 simulation runs** across 7 research questions
- **15 experiments** covering quorum design, capture mitigation, pipeline effects, treasury policy, inter-DAO cooperation, AI governance, and counterfactual rule comparison
